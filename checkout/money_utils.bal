...
# Returns true if values firstValue and secondValue have a currency code and they are the same values.
#
...
isolated function multiplySlow(stubs:Money money, int factor) returns stubs:Money {
    int t = factor;
